...
/**
 * Created by KataMar on 05/10/17.
 */
public class Run_ForRobert {
...
//-------------------------------------------------------------------------------//
        ...
        //delete the old data from the file "data_for_average_of_suffered_for_the_wholeTrail.txt"
        //this file contains the accumulated number of infected people after each simulation
        // # separates the different probabilities from each other. That is the first x number of simulations are represented
        //for the P(infect) = 0.00, the next x number of simulations are for P(infect) 0.05 etc
        File f_old2 = new File("data_for_average_of_suffered_for_the_wholeTrail.txt");
        f_old2.delete();
      ...
      //  for (int j = 0; j<probabilities.size(); j++) {
            ...
            for (int i = 0; i < numberOfRuns; i++) {
                ...
                life.run(size, pill , pdead, minDays, maxDays, infectedM, infectedN, differentseed.get(i),display) ;
            }
